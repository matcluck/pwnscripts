# pwnscripts
## genbadchars.py
Generates a Python array to help discover bad characters. To omit characters, supply them as arguments in hex format.
```
$ python3 genbadchars.py 00 0d
badchars = (b"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0e\x0f\x10\x11"
...
b"\xf2\xf3\xf4\xf5\xf6\xf7\xf8\xf9\xfa\xfb\xfc\xfd\xfe\xff")
```